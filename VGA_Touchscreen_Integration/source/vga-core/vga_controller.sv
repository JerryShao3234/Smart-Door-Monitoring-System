...
module vga_controller(	vga_clock, resetn, pixel_colour, memory_address,
	...
	begin
		...
		begin
			...
			begin
				VGA_R[index] <= on_screen & pixel_colour[BITS_PER_COLOUR_CHANNEL-1:0];
				VGA_G[index] <= on_screen & pixel_colour[BITS_PER_COLOUR_CHANNEL-1:0];
				VGA_B[index] <= on_screen & pixel_colour[BITS_PER_COLOUR_CHANNEL-1:0];
			end
		end
	end
	*///    added for handling greyscale 
