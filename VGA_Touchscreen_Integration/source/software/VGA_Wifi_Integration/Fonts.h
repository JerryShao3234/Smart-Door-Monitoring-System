...
#define SMALL_FONT_XPIXELS	5				// width of Font5x7 characters in pixels (no spacing)
#define SMALL_FONT_YPIXELS	7				// height of Font5x7 characters in pixels (no spacing)
